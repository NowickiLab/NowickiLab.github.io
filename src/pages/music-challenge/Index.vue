<template lang="html">
  <div>
    ...
    <ol>
      ...
      <li>Likes and comments on the current and past daily topics are also encouraged. Liking and commenting is not limited to each day - let's enjoy the music any time we feel like it!</li>
