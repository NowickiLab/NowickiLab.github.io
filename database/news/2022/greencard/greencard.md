...
To see just how much work goes into the application itself (after collecting and collating __TONS__ of other documents, letters of support from around the globe, etc.) - see the picture. The only advice that can be drawn from all this: **START EARLY**. This helps with the --unnecessary, extra-- stress when waiting for the decision, but also permits time to go throught the records more thoroughly, finding otherwise overseen docs, etc.
